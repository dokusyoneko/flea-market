...
CREATE TABLE `likes` (
  ...
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `likes_user_id_product_id_unique` (`user_id`,`product_id`),
...
INSERT INTO `migrations` VALUES (1,'2014_10_12_000000_create_users_table',1),(2,'2014_10_12_100000_create_password_resets_table',1),(3,'2014_10_12_200000_add_two_factor_columns_to_users_table',1),(4,'2019_08_19_000000_create_failed_jobs_table',1),(5,'2019_12_14_000001_create_personal_access_tokens_table',1),(6,'2025_11_03_153701_create_user_profiles_table',1),(7,'2025_11_03_153702_create_categories_table',1),(8,'2025_11_03_153748_create_products_table',1),(9,'2025_11_03_153946_create_product_categories_table',1),(10,'2025_11_03_154007_create_likes_table',1),(11,'2025_11_03_154029_create_comments_table',1),(12,'2025_11_03_154042_create_purchases_table',1);
...
INSERT INTO `users` VALUES (1,'りゅーたろー','ryutaro@ryutaro',NULL,'$2y$10$0Y/J4JPSf0lhYmHDHelmhelzWKCj1TipvQdw0j1vB7R1uRmix/UWe',NULL,NULL,NULL,'2025-12-07 15:04:49','2025-12-07 15:04:49');
...
-- Dump completed on 2025-12-08 17:04:07
